# crm-users-data-standards

## Purpose

Normalización canónica de datos CRM/Users (email, teléfono E.164, NIF, nombres de persona y cuenta, textos, fechas, slug) unificada en escritura HTTP, import Excel y comando de backfill `data:normalize-crm-users`, con skips seguros y scope multiempresa.
