...
- [x] 3.1 Probar que, sin agendas, cualquier intento de crear evento muestra el SweetAlert y no persiste datos. (implementado en handleNewEvent de Schedule/Index.jsx)
- [x] 3.2 Probar que el backend rechaza eventos con fin antes de inicio o con menos de 15 minutos de diferencia, incluso si el frontend falla. (validación en ScheduleEventStoreRequest/UpdateRequest; tests en ScheduleEventValidationTest)
- [x] 3.3 Añadir/actualizar tests automatizados de agenda que cubran estas validaciones críticas. (tests/Feature/ScheduleEventValidationTest.php)
