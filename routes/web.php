...
Route::middleware(['web', 'auth', 'company'])->prefix('admin')->group(function(){
    ...
    //Incidences:
    Route::get('/incidences', [IncidenceController::class, 'index'])->name('incidences.index')->middleware('permission:incidences.index');
    ...
    Route::get('/marketing-campaigns/create', [MarketingCampaignController::class, 'create'])->name('marketing-campaigns.create')->middleware('permission:marketing-campaigns.create');
