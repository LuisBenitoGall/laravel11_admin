...
export default function Sectors({ auth, title, subtitle }) {
  ...
  useEffect(() => {
    ...
    setLoadingTree(true);
    axios
      .get(route('categories.tree', 'users'))
      .then(res => {
        if (!mounted) return;
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(route('users.categories.search'), {
        params: {
      ...
      .then(res => {
        if (cancel) return;
        const c = Array.isArray(res?.data?.users) ? res.data.users : [];
    ...
    return (
        ...
        >
            ...
            <div className="contents">
                <div className="row pt-2" id="userCategories">
                    {/* Árbol de categorías */}
                    <div className="col-lg-3">
                        <div className="card">
                            <div className="card-header fw-semibold py-3">{__('categorias_indice')}</div>
                    ...
                    <div className="col-lg-9">
                        <div className="card">
                            <div className="card-header d-flex align-items-center justify-content-between">
                                ...
                                {selected && (users.length > 0 || crm.length > 0) && (
                            ...
                            <div className="card-body">
                                ...
                                {selected && !loading && users.length === 0 && crm.length === 0 && (
                                <div className="text-muted py-5 text-center">
                                    {__('sin_resultados')}
                                </div>
                                )}
