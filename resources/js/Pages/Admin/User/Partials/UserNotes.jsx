// resources/js/Pages/Admin/User/Partials/UserNotes.jsx
...
export default function UserNotes({
    ...
    const handleRelevanceChange = async (note, value) => {
        ...
        try {
            ...
            setError(
                __('error_actualizando_relevancia') ||
            ...
            onConfirm: async () => {
                ...
                try {
                    await axios.put(
                        ...
                        { archive: true } // ⬅ dejamos preparado para futuros "false"
                    );

                    // Como esta vista solo muestra activas, la quitamos del listado
                    setNotes((prev) => prev.filter((n) => n.id !== note.id));

                    // Si justo se estaba editando, saneamos estados
                    if (editingNoteId === note.id) {
                        cancelEditing();
                    }
                    if (editingReminderId === note.id) {
