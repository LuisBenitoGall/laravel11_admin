...
export default function CrmListShowView({ record }) {
            ...
            <div className="vertical-scroll">
                ...
                <div className="row mb-4">
                    ...
                    <div className="col-3 text-end">
                        {list.avatar?.image ? (
                            ...
                            >
                                <i className="la la-list text-white" style={{ fontSize: '4rem' }}></i>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="row my-4">
                    <div className="col-12">
                        ...
                        {Array.isArray(list.companies) && list.companies.length > 0 ? (
