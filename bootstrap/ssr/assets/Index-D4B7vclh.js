...
import { u as useCompanySession } from "./Sidebar-BsJktKN8.js";
import "sweetalert2";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "card shadow-sm h-100", children: [
    /* @__PURE__ */ jsxs("div", { className: "card-header d-flex justify-content-between align-items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "fw-semibold", children: __("contactos_ultimos") || "Últimos contactos" })
      ] }),
      hasItems && /* @__PURE__ */ jsx("span", { className: "badge bg-secondary", children: items.length })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "card-body p-2", style: { maxHeight: "320px", overflowY: "auto" }, children: [
      ...
      !loading && !error && !hasItems && /* @__PURE__ */ jsx("p", { className: "text-muted small mb-0", children: __("no_hay_contactos_nuevos") || "No hay nuevos contactos." }),
      !loading && !error && hasItems && /* @__PURE__ */ jsx("ul", { className: "list-unstyled mb-0", children: items.map((c) => /* @__PURE__ */ jsx("li", { className: "border-bottom py-2", children: /* @__PURE__ */ jsx("div", { className: "d-flex align-items-start", children: /* @__PURE__ */ jsxs("div", { className: "flex-grow-1 ms-2", children: [
        ...
        c.last_message && /* @__PURE__ */ jsx("div", { className: "mt-1 small text-truncate", style: { maxWidth: "100%" }, children: /* @__PURE__ */ jsx("em", { children: c.last_message }) }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "card shadow-sm h-100", children: [
    /* @__PURE__ */ jsxs("div", { className: "card-header d-flex justify-content-between align-items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "fw-semibold", children: __("recordatorios") || "Recordatorios" })
      ] }),
