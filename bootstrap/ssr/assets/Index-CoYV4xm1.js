...
import { u as useCompanySession } from "./Sidebar-YTcA2cN_.js";
import { u as useSweetAlert } from "./useSweetAlert-D4PAsWYN.js";
import ScheduleFormModal from "./ScheduleFormModal-DhBPwGBo.js";
import AuthorizedUsersModal from "./AuthorizedUsersModal-BCy8hDBy.js";
import EventFormModal from "./EventFormModal-CxmuM5If.js";
          ...
          ReusableModal,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mb-3", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "form-text", children: isGmailAddress((_f = auth == null ? void 0 : auth.user) == null ? void 0 : _f.email) ? __("email_autocompletado_gmail") || "Se usa el email Gmail de tu usuario." : __("email_info_google") || "Este campo es informativo: Google te pedirá iniciar sesión para autorizar la conexión." })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-end gap-2", children: [
                ...
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    disabled: googleCalendarLoading,
                    children: googleCalendarLoading ? /* @__PURE__ */ jsxs(Fragment, { children: [
                      ...
                      /* @__PURE__ */ jsx("i", { className: `la ${googleCalendarConnected ? "la-unlink" : "la-google"} me-1` }),
                      googleCalendarConnected ? __("google_desconectar") || "Desconectar" : __("google_conectar") || "Conectar"
                    ] })
                  }
                )
              ] })
