...
function CrmcampaignShowView({ record }) {
  var _a;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "contact-show-view", children: [
    /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-start mb-3", children: [
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h4", { className: "mb-1", children: campaign.name || `${campaign.name}` }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "vertical-scroll", children: [
      /* @__PURE__ */ jsxs("div", { className: "row mb-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "col-3 text-end", children: ((_a = campaign.avatar) == null ? void 0 : _a.image) ? /* @__PURE__ */ jsx(
          "img",
          {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("i", { className: "la la-campaign text-white", style: { fontSize: "4rem" } })
          }
        ) })
      ] }),
      /* @__PURE__ */ jsx("hr", {}),
      /* @__PURE__ */ jsx("div", { className: "row my-4", children: /* @__PURE__ */ jsxs("div", { className: "col-12", children: [
        ...
        Array.isArray(campaign.companies) && campaign.companies.length > 0 ? /* @__PURE__ */ jsx("div", { className: "list-group", children: campaign.companies.map((company) => /* @__PURE__ */ jsx(
          "div",
          {
...
export {
  CrmcampaignShowView as default
};
