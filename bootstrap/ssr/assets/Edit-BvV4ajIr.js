...
import { F as FlashMessage, A as AdminAuthenticated } from "./AdminAuthenticatedLayout-C5syfI8B.js";
import { router, usePage, useForm, Head } from "@inertiajs/react";
import "@inertiajs/inertia";
import "react-tooltip";
import { useState, useEffect } from "react";
import { S as SpinnerInline } from "./SpinnerInline-D6nmpcby.js";
import { u as useMarketingListBrevoExport, B as BrevoSyncStatus } from "./BrevoSyncStatus-Bv-6UIhc.js";
...
import MarketingListMembersTab from "./MarketingListMembersTab-B0pvpyOA.js";
...
import "prop-types";
import "./TableExporter-ozLWJjAM.js";
...
function BrevoExportAlert({ __, visible = false }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "alert alert-info d-flex align-items-center mb-3", role: "status", children: /* @__PURE__ */ jsx(SpinnerInline, { text: __("lista_export_brevo_en_proceso") }) });
}
...
function Index({
  ...
  if (permissions == null ? void 0 : permissions["marketing-lists.edit"]) {
    actions.push({
      ...
      onClick: (e) => {
        if (e == null ? void 0 : e.preventDefault) {
          e.preventDefault();
        }
    ...
    AdminAuthenticated,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "contents pb-4", children: [
          /* @__PURE__ */ jsx(BrevoExportAlert, { __, visible: brevoExportInProgress }),
          /* @__PURE__ */ jsxs("div", { className: "row", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "col-12 mt-2 mb-4", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-muted ms-5 d-inline-flex align-items-center", children: /* @__PURE__ */ jsx(BrevoSyncStatus, { list, __, isSubmitting: exportingListId === list.id }) })
            ] })
          ] }),
          /* @__PURE__ */ jsx(
            Tabs,
