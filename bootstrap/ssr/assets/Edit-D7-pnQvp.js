...
function Index({ auth, session, title, subtitle, type, availableLocales }) {
  var _a;
  ...
  useHandleDelete("iva_tipo", "iva-types.destroy", [type.id]);
  ...
  const actions = [];
  if (permissions == null ? void 0 : permissions["iva-types.index"]) {
    actions.push({
  ...
  if (permissions == null ? void 0 : permissions["iva-types.destroy"]) {
    actions.push({
      text: __("eliminar"),
      icon: "la-trash",
      method: "delete",
          ...
          /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
            /* @__PURE__ */ jsxs("div", { className: "row gy-3", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "col-lg-3", children: /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("label", { htmlFor: "iva", className: "form-label", children: [
                  __("iva"),
                  "*"
                ] }),
                /* @__PURE__ */ jsx(
                ...
                /* @__PURE__ */ jsx(InputError, { message: errors.iva })
              ] }) }),
              /* @__PURE__ */ jsx("div", { className: "col-lg-3", children: /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { htmlFor: "equivalence_surcharge", className: "form-label", children: __("recargo_equivalencia") }),
                /* @__PURE__ */ jsx(
                  TextInput,
                  {
                    className: "text-end setDecimal",
                ...
                /* @__PURE__ */ jsx(InputError, { message: errors.equivalence_surcharge })
              ] }) })
            ] }),
