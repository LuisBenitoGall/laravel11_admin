...
function Sectors({ auth, title, subtitle }) {
  ...
  useEffect(() => {
    let mounted = true;
    setLoadingTree(true);
    axios.get(route("categories.tree", "users")).then((res) => {
      var _a;
      if (!mounted) return;
  ...
  useEffect(() => {
    ...
    let cancel = false;
    setLoading(true);
    axios.get(route("users.categories.search"), {
      params: {
      ...
      var _a, _b;
      if (cancel) return;
      const c = Array.isArray((_a = res == null ? void 0 : res.data) == null ? void 0 : _a.users) ? res.data.users : [];
  ...
  return /* @__PURE__ */ jsxs(
    AdminAuthenticated,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "contents", children: /* @__PURE__ */ jsxs("div", { className: "row pt-2", id: "userCategories", children: [
          /* @__PURE__ */ jsx("div", { className: "col-lg-3", children: /* @__PURE__ */ jsxs("div", { className: "card", children: [
            /* @__PURE__ */ jsx("div", { className: "card-header fw-semibold py-3", children: __("categorias_indice") }),
          ...
          /* @__PURE__ */ jsx("div", { className: "col-lg-9", children: /* @__PURE__ */ jsxs("div", { className: "card", children: [
            /* @__PURE__ */ jsxs("div", { className: "card-header d-flex align-items-center justify-content-between", children: [
              ...
              selected && (users.length > 0 || crm.length > 0) && /* @__PURE__ */ jsx("div", { style: { minWidth: 320 }, children: /* @__PURE__ */ jsxs(InputGroup, { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "card-body", children: [
              !selected && /* @__PURE__ */ jsx("div", { className: "text-muted py-5 text-center", children: __("usuario_selec_categoria") }),
              ...
              selected && !loading && users.length === 0 && crm.length === 0 && /* @__PURE__ */ jsx("div", { className: "text-muted py-5 text-center", children: __("sin_resultados") }),
              selected && !loading && (users.length > 0 || crm.length > 0) && /* @__PURE__ */ jsxs(Fragment, { children: [
                users.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("div", { className: "fw-semibold mb-2", children: __("usuarios") }),
                  /* @__PURE__ */ jsx("div", { className: "row row-cols-1 row-cols-md-2 row-cols-xl-3", children: users.map((item) => /* @__PURE__ */ jsx("div", { className: "col mb-3", children: /* @__PURE__ */ jsx(Card, { item }) }, `c-${item.id}`)) }),
