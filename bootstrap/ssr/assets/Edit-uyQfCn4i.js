...
import { L as LocationSelects } from "./LocationSelects-iO4tuMRw.js";
...
function ManageUserAddresses({ userId, addresses = [], countries = [] }) {
  ...
  const renderTown = (address) => {
    var _a, _b, _c;
    const townName = address.town_name || ((_a = address.town) == null ? void 0 : _a.name) || ((_b = address.town) == null ? void 0 : _b.label) || ((_c = address.town) == null ? void 0 : _c.town) || "";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "card mb-3", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "card-body p-0", children: addresses.length === 0 ? /* @__PURE__ */ jsx("p", { className: "mb-0 p-3 text-muted small", children: __("No hay direcciones definidas para este usuario.") }) : /* @__PURE__ */ jsxs(Table, { striped: true, hover: true, responsive: true, size: "sm", className: "mb-0", children: [
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", { children: __("Etiqueta") }),
        /* @__PURE__ */ jsx("th", { children: __("Dirección") }),
        /* @__PURE__ */ jsx("th", { children: __("CP / Población") }),
        /* @__PURE__ */ jsx("th", { children: __("Observaciones") }),
        /* @__PURE__ */ jsx("th", { className: "text-center", children: __("Principal") }),
        /* @__PURE__ */ jsx("th", { className: "text-end", children: __("Acciones") })
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { children: addresses.map((address) => /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("td", { children: address.label || "—" }),
        /* @__PURE__ */ jsxs("td", { children: [
          address.address,
          address.address_extra && /* @__PURE__ */ jsx("div", { className: "text-muted small", children: address.address_extra })
        ] }),
        /* @__PURE__ */ jsx("td", { children: renderTown(address) || "—" }),
        /* @__PURE__ */ jsx("td", { className: "small text-muted", children: address.observations || "—" }),
        /* @__PURE__ */ jsx("td", { className: "text-center", children: address.is_main ? /* @__PURE__ */ jsxs(Badge, { bg: "success", children: [
        ...
        /* @__PURE__ */ jsx("td", { className: "text-end", children: /* @__PURE__ */ jsxs("div", { className: "btn-group btn-group-sm", children: [
          /* @__PURE__ */ jsx(
            OverlayTrigger,
            {
              placement: "top",
              overlay: /* @__PURE__ */ jsx(Tooltip, { id: `tt-edit-${address.id}`, children: __("Editar") }),
              children: /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              placement: "top",
              overlay: /* @__PURE__ */ jsx(Tooltip, { id: `tt-delete-${address.id}`, children: __("Eliminar") }),
              children: /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
