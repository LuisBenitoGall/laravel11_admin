...
function ModalUserCreate({ show, onClose, onCreate, companyId, side, salutations, contact_types, crm_account }) {
  var _a;
      ...
      children: /* @__PURE__ */ jsxs("form", { ref: formRef, onSubmit: (e) => {
        ...
        /* @__PURE__ */ jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsx("div", { className: "position-relative", children: /* @__PURE__ */ jsxs("div", { className: "row", children: [
          /* @__PURE__ */ jsxs("div", { className: "col-lg-6", children: [
            ...
            /* @__PURE__ */ jsx(TextInput, { type: "text", value: data.department, onChange: (e) => setData("department", e.target.value), required: true }),
            ...
            /* @__PURE__ */ jsxs(
              SelectInput,
              {
                ...
                children: [
                  ...
                  contact_types.map((option) => /* @__PURE__ */ jsx("option", { value: option.value, children: option.label }, option.value))
                ]
              }
            ),
