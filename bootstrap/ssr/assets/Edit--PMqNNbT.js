...
function Index({ auth, session, title, subtitle, town, province, availableLocales }) {
  var _a;
  ...
  useHandleDelete("poblacion", "towns.delete", [town.id]);
  ...
  if (permissions == null ? void 0 : permissions["towns.destroy"]) {
    actions.push({
      text: __("eliminar"),
      icon: "la-trash",
      method: "delete",
