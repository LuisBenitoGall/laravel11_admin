...
function Sidebar(auth) {
  ...
  useEffect(() => {
    ...
    axios.get("/secondary-menu").then((response) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `app-menu navbar-menu ${isOpen ? "show" : "hide"}`, children: [
    /* @__PURE__ */ jsx("div", { className: "navbar-brand-box", children: /* @__PURE__ */ jsxs(Link, { href: route("dashboard.index"), className: "logo", children: [
      /* @__PURE__ */ jsx("span", { className: "logo-sm", children: /* @__PURE__ */ jsx("img", { src: "/img/logo-amdt.png", alt: "Radnify", className: "img-fluid p-3" }) }),
      /* @__PURE__ */ jsx("span", { className: "logo-lg", children: /* @__PURE__ */ jsx("img", { src: "/img/logo-amdt.png", alt: "Radnify", className: "img-fluid p-3" }) })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "company-logo text-center", children: ((_a = companySettings == null ? void 0 : companySettings.company) == null ? void 0 : _a.logo) && (() => {
      var _a2;
      ...
      return logoSrc ? /* @__PURE__ */ jsx("img", { src: logoSrc, alt: ((_a2 = companySettings.company) == null ? void 0 : _a2.name) || "", className: "img-fluid" }) : null;
    })() }),
      ...
      (() => {
        ...
        return /* @__PURE__ */ jsxs("li", { className: `nav-item ${isActive ? "active text-white" : ""}`, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: `collapse menu-dropdown ${isActive ? "show" : ""}`, id: "menuCompanies", children: /* @__PURE__ */ jsxs("ul", { className: "nav nav-sm flex-column", children: [
            ...
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(NavLink, { href: route("business-areas.index"), className: `nav-link menu-link ${currentSlug === "business-areas" ? "active text-white" : ""}`, children: /* @__PURE__ */ jsx("span", { children: txt_areas_negocio }) }) }),
