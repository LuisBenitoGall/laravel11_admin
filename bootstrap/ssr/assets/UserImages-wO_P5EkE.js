...
function DropzoneGallery({
  ...
  const isPdf = (img) => {
    if ((img == null ? void 0 : img.file) && typeof img.file === "object" && img.file.type === "application/pdf") return true;
    const u = ((img == null ? void 0 : img.url) || (img == null ? void 0 : img.path) || (img == null ? void 0 : img.filename) || (img == null ? void 0 : img.image) || "").toLowerCase();
    const n = ((img == null ? void 0 : img.name) || "").toLowerCase();
    return typeof u === "string" && (u.endsWith(".pdf") || u.includes("application/pdf")) || typeof n === "string" && n.endsWith(".pdf");
  };
        ...
        return /* @__PURE__ */ jsx("div", { className: "col-6 col-sm-4 col-md-3", children: /* @__PURE__ */ jsxs("div", { className: "position-relative border rounded overflow-hidden", style: { minHeight: 80 }, children: [
          isPdfItem ? /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("i", { className: "la la-file-pdf", style: { fontSize: "2rem" } }),
                /* @__PURE__ */ jsx("span", { className: "small mt-1", children: "PDF" })
              ]
            }
          ) : /* @__PURE__ */ jsx(
            "img",
          ...
          /* @__PURE__ */ jsxs("div", { style: { position: "absolute", top: 6, right: 6, display: "flex", flexDirection: "column", gap: 6 }, children: [
            ...
            setFeaturedUrl && !isPdfItem && /* @__PURE__ */ jsx(
              OverlayTrigger,
              {
                placement: "left",
