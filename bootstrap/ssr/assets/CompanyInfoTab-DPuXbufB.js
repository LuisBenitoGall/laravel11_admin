...
function CompanyFormEdit({
  ...
  const { data, setData, post, reset, errors, processing } = useForm({
    ...
    cost_center_id: String((crm_account == null ? void 0 : crm_account.cost_center_id) ?? company.cost_center_id ?? ""),
    business_type: (crm_account == null ? void 0 : crm_account.business_type) ?? ""
  });
  useEffect(() => {
    setData("name", company.name ?? "");
    setData("tradename", company.tradename ?? "");
    setData("nif", company.nif ?? "");
    setData("cost_center_id", String(company.cost_center_id ?? (crm_account == null ? void 0 : crm_account.cost_center_id) ?? ""));
    setData("business_type", company.business_type ?? (crm_account == null ? void 0 : crm_account.business_type) ?? "");
  }, [company]);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxs("div", { className: "row gy-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "col-lg-6", children: [
        /* @__PURE__ */ jsx("label", { className: "form-label", children: __("nombre_comercial") }),
        /* @__PURE__ */ jsx(
          TextInput,
          {
            type: "text",
      ...
      crm_account != false && /* @__PURE__ */ jsx("div", { className: "col-lg-6", children: /* @__PURE__ */ jsxs("div", { children: [
          ...
          SelectInput,
          {
            ...
            children: [
              ...
              cost_centers.map((cc, idx) => {
                const v = String((cc == null ? void 0 : cc.id) ?? (cc == null ? void 0 : cc.value) ?? (cc == null ? void 0 : cc.slug) ?? idx);
                const label = (cc == null ? void 0 : cc.name) ?? (cc == null ? void 0 : cc.title) ?? (cc == null ? void 0 : cc.label) ?? String(cc);
                return /* @__PURE__ */ jsx("option", { value: v, children: label }, v);
              })
            ]
          }
        ),
