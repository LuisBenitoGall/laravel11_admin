...
function EmailsCell({ emails = [] }) {
  ...
  const popoverTitle = moreCount === 1 ? __("email_mas") : `${moreCount} ${__("emails_mas")}`;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    moreCount > 0 && /* @__PURE__ */ jsx(
      OverlayTrigger,
      {
        trigger: ["hover", "focus"],
        placement: "auto",
        overlay: /* @__PURE__ */ jsxs(Popover, { id: "emails-popover", className: "emails-cell-popover", children: [
          /* @__PURE__ */ jsx(Popover.Header, { as: "h6", children: popoverTitle }),
          /* @__PURE__ */ jsx(Popover.Body, { className: "d-flex flex-column gap-1", children: others.map((email, i) => /* @__PURE__ */ jsx("span", { className: "text-nowrap", children: email }, i)) })
        ] }),
...
function renderCellContent(value, column, rowData = {}) {
  ...
  if (column.key === "other_emails") {
    return /* @__PURE__ */ jsx(EmailsCell, { emails: value });
  }
