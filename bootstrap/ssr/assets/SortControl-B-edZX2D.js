...
const ColumnFilter = ({ columns, visibleColumns, toggleColumn }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "column-filter position-relative d-inline-block float-start", children: [
    ...
    isOpen && /* @__PURE__ */ jsx("ul", { className: "dropdown-menu show position-absolute", children: columns.filter((col) => !col.filterOnly).map(({ key, label }) => /* @__PURE__ */ jsx("li", { className: "dropdown-item d-flex justify-content-between align-items-center", children: /* @__PURE__ */ jsxs("label", { className: "d-flex w-100 justify-content-between align-items-center", children: [
...
function FilterRow({
  ...
  return /* @__PURE__ */ jsx("thead", { className: "tbl-filters", children: /* @__PURE__ */ jsxs("tr", { className: "text-nowrap", children: [
    prependCount > 0 && Array.from({ length: prependCount }).map((_, idx) => /* @__PURE__ */ jsx("th", {}, `prepend-${idx}`)),
    translatedColumns.map((col) => {
      var _a2, _b2;
      const localValue = textValues[col.key] || "";
      return /* @__PURE__ */ jsx("th", { className: col.filterOnly || visibleColumns.includes(col.key) ? "" : "d-none", children: /* @__PURE__ */ jsxs("div", { className: "input-group", children: [
        col.filter === "text" && /* @__PURE__ */ jsx(
          OverlayTrigger,
          {
            placement: "top",
            trigger: ["hover", "focus"],
            overlay: /* @__PURE__ */ jsx(Tooltip, { id: `wc-${col.key}`, children: __("filtro_comodin_hint") }),
