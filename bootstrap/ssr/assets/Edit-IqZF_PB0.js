...
import CompanyInfoTab from "./CompanyInfoTab-CPEcQPeq.js";
import CompanyUsersTab from "./CompanyUsersTab-DWd2uiPI.js";
...
function Index({ auth, session, title, subtitle, provider, relation, users, rows, salutations, tab, availableLocales }) {
  var _a;
