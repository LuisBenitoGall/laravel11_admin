...
function CompanyNotes({
    ...
    showConfirm({
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          setError(
            __("error_eliminando_nota_empresa") || "Error eliminando la nota de la empresa."
          );
        } finally {
          setDeletingId(null);
        }
  ...
  const handleRelevanceChange = async (note, value) => {
    ...
    try {
      ...
      setError(
        __("error_actualizando_relevancia_empresa") || "Error actualizando la relevancia."
      );
    } finally {
  ...
  const handleTogglePin = async (note) => {
    ...
    try {
      ...
      setError(
        __("error_pin_nota_empresa") || "Error al fijar o desfijar la nota."
      );
    } finally {
      setSavingPinId(null);
    }
  ...
  const saveEdit = async (note) => {
    ...
    try {
      ...
      setError(
        __("error_actualizando_nota_empresa") || "Error actualizando la nota."
      );
    } finally {
    ...
    showConfirm({
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          setError(
            __("error_archivando_nota_empresa") || "Error archivando la nota."
          );
        } finally {
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          notes.length === 0 && !loading && !error && /* @__PURE__ */ jsx("p", { className: "text-center text-warning my-5", children: __("notas_no_mas") || "No hay notas para esta empresa." }),
          notes.map((note) => {
            var _a2, _b;
              ...
              /* @__PURE__ */ jsxs("div", { className: "card-body", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "small text-muted", children: [
                  /* @__PURE__ */ jsxs("span", { children: [
                    ...
                    ":",
                    " ",
                    /* @__PURE__ */ jsx("strong", { children: ((_a2 = note.user) == null ? void 0 : _a2.name) || ((_b = note.owner) == null ? void 0 : _b.name) || note.user_name || (note.user_id ? `ID: ${note.user_id}` : __("desconocido") || "Desconocido") })
                  ] }),
