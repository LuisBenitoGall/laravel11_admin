  ...
  return /* @__PURE__ */ jsxs("header", { id: "page-topbar", children: [
    /* @__PURE__ */ jsx("div", { className: "layout-width", id: "top-menu", children: /* @__PURE__ */ jsxs("div", { className: "navbar-header", children: [
      /* @__PURE__ */ jsxs("div", { className: "d-flex", children: [
        ...
        /* @__PURE__ */ jsx("button", { type: "button", className: "btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger", id: "topnav-hamburger-icon", children: /* @__PURE__ */ jsxs("span", { className: "hamburger-icon", children: [
          /* @__PURE__ */ jsx("span", {}),
          /* @__PURE__ */ jsx("span", {}),
          /* @__PURE__ */ jsx("span", {})
        ] }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center", children: [
        menuLocales && /* @__PURE__ */ jsxs("div", { className: "language-selector position-relative", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx(
                ...
                {
                  placement: "left",
                  overlay: /* @__PURE__ */ jsx(Tooltip, { className: "ttp-top", children: __("idiomas") }),
          ...
          isDropdownOpen && /* @__PURE__ */ jsx("ul", { className: "dropdown-menu show position-absolute", children: Object.keys(languages).map((key) => {
        ...
        menuCustom && /* @__PURE__ */ jsx("div", { className: "custom-menu position-relative", children: /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(
              ...
              {
                placement: "left",
                overlay: /* @__PURE__ */ jsx(Tooltip, { className: "ttp-top", children: __("menu_preferencias") }),
                children: /* @__PURE__ */ jsx("div", { className: "d-flex justify-content-center w-100", children: /* @__PURE__ */ jsx("i", { className: "la la-cog" }) })
              },
              "custom1"
            )
          }
        ) }),
        menuChat && /* @__PURE__ */ jsx("div", { className: "chat-warning position-relative", children: /* @__PURE__ */ jsx(
          "button",
          {
            className: "btn btn-top-header rounded-pill d-flex align-items-center mx-1",
            children: /* @__PURE__ */ jsx(
              ...
              {
                placement: "left",
                overlay: /* @__PURE__ */ jsx(Tooltip, { className: "ttp-top", children: __("chat") }),
                children: /* @__PURE__ */ jsx("div", { className: "d-flex justify-content-center w-100", children: /* @__PURE__ */ jsx("i", { className: "la la-comment-alt" }) })
              },
              "chat1"
            )
          }
        ) }),
        menuNotifications && /* @__PURE__ */ jsx("div", { className: "notifications-warning position-relative", children: /* @__PURE__ */ jsx(
          "button",
          {
            className: "btn btn-top-header rounded-pill d-flex align-items-center mx-1",
            children: /* @__PURE__ */ jsx(
              ...
              {
                placement: "left",
                overlay: /* @__PURE__ */ jsx(Tooltip, { className: "ttp-top", children: __("notificaciones") }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "dropdown ms-sm-1 header-item topbar-user", children: [
          /* @__PURE__ */ jsx("button", { type: "button", className: "btn p-0", id: "page-header-user-dropdown", "data-bs-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", children: /* @__PURE__ */ jsxs("span", { className: "d-flex align-items-center", children: [
            ...
            ) : /* @__PURE__ */ jsx("div", { className: "rounded-circle header-profile-user d-flex justify-content-center align-items-center", style: { width: "30px", height: "30px", backgroundColor: "#fff" }, children: /* @__PURE__ */ jsx("i", { className: "la la-user-tie text-muted" }) }),
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "align-middle", "data-key": "t-logout", children: "Logout" })
                ]
              }
            )
          ] })
