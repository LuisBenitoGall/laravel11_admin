...
function Edit({ auth, session, title, subtitle, costCenter }) {
  var _a;
  ...
  if (permissions == null ? void 0 : permissions["cost-centers.index"]) {
    actions.push({ text: __("centros_coste_volver"), icon: "la-angle-left", url: "cost-centers.index", modal: false });
  }
  if (permissions == null ? void 0 : permissions["cost-centers.destroy"]) {
    actions.push({ text: __("eliminar"), icon: "la-trash", method: "delete", url: "cost-centers.destroy", params: [costCenter.id], title: __("centro_coste_eliminar"), message: __("centro_coste_eliminar_confirm"), modal: false });
  }
    ...
    /* @__PURE__ */ jsxs("div", { className: "contents pb-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "row", children: [
        /* @__PURE__ */ jsx("div", { className: "col-12", children: /* @__PURE__ */ jsxs("h2", { children: [
          __("centro_coste"),
          " ",
          /* @__PURE__ */ jsx("u", { children: costCenter.name })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "col-12 mt-2 mb-4", children: [
          /* @__PURE__ */ jsxs("span", { className: "text-muted me-5", children: [
            __("creado"),
            ": ",
            /* @__PURE__ */ jsx("strong", { children: costCenter.formatted_created_at })
          ] }),
          /* @__PURE__ */ jsxs("span", { className: "text-muted me-5", children: [
            __("actualizado"),
            ": ",
            /* @__PURE__ */ jsx("strong", { children: costCenter.formatted_updated_at })
          ] })
        ] })
      ] }),
