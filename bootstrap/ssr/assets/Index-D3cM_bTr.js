              ...
              /* @__PURE__ */ jsxs("td", { className: "text-end", children: [
                ...
                (() => {
                  ...
                  return /* @__PURE__ */ jsx(
                    ...
                    {
                      placement: "top",
                      overlay: /* @__PURE__ */ jsx(Tooltip, { className: "ttp-top", children: s.tooltip }),
                      children: /* @__PURE__ */ jsx("span", { className: `ms-1 ${s.color}`, style: { fontSize: "1.1rem", verticalAlign: "middle" }, children: /* @__PURE__ */ jsx("i", { className: `la ${s.icon}` }) })
                    },
                    "brevo-status-" + list.id
                  );
                })(),
                (permissions == null ? void 0 : permissions["marketing-lists.edit"]) && /* @__PURE__ */ jsx(
                  OverlayTrigger,
