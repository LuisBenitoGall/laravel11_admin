...
import { C as ColorPicker } from "./ColorPicker-YL-42Dpw.js";
...
import "react-color";
function Index({ auth, session, title, subtitle, levels, availableLocales }) {
  var _a;
        ...
        /* @__PURE__ */ jsx("div", { className: "contents pb-4", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsxs("div", { className: "row gy-3", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "col-lg-3", children: /* @__PURE__ */ jsxs("div", { className: "position-relative", children: [
              /* @__PURE__ */ jsxs("label", { htmlFor: "level", className: "form-label", children: [
                __("nivel"),
                "*"
              ] }),
              /* @__PURE__ */ jsxs(
                SelectInput,
                {
                  ...
                  children: [
                    ...
                    levelsArray.map((option) => /* @__PURE__ */ jsx("option", { value: option.value, children: option.label }, option.value))
                  ]
                }
              ),
              /* @__PURE__ */ jsx(InfoPopover, { code: "module-level" }),
