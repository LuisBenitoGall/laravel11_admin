...
import CrmOpportunitiesShowView from "./CrmOpportunitiesShowView-BBU2rYDn.js";
            ...
            /* @__PURE__ */ jsx("tbody", { children: opportunities.data.map((campaign) => /* @__PURE__ */ jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsxs("td", { className: "text-end", children: [
                (permissions == null ? void 0 : permissions["crm-opportunities.edit"]) && /* @__PURE__ */ jsx(
                  ...
                  {
                    placement: "top",
                    overlay: /* @__PURE__ */ jsx(Tooltip, { className: "ttp-top", children: campaign.status == 1 ? __("oportunidad_activa") : __("oportunidad_inactiva") }),
