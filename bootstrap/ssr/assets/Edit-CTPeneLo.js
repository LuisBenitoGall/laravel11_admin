...
function Edit({ auth, session, title, subtitle, costCenter, company }) {
  var _a;
    ...
    /* @__PURE__ */ jsxs("div", { className: "contents pb-4", children: [
      ...
      /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxs("div", { className: "row gy-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "col-lg-4", children: [
          /* @__PURE__ */ jsx("label", { className: "form-label", children: __("codigo") }),
          /* @__PURE__ */ jsx(TextInput, { value: data.code, onChange: (e) => setData("code", e.target.value), maxLength: 50 }),
