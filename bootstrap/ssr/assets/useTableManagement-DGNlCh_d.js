...
function FilterRow({ columns, queryParams, visibleColumns, SearchFieldChanged }) {
  var _a, _b;
  const __ = useTranslation();
...
function useTableManagement({
  ...
  const initialVisible = Array.isArray((_b = props.columnPreferences) == null ? void 0 : _b[table]) ? props.columnPreferences[table] : allColumnKeys;
  ...
  entityName.includes("-") ? entityName.replace(/-/g, "_") : entityName;
