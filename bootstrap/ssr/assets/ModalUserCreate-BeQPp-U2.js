...
import { F as FormDatePickerInput } from "./DatePickerToForm-BNatYC8y.js";
...
function ModalUserCreate({
  ...
  const handleConfirm = (submitEvent) => {
    ...
    const formEl = (submitEvent == null ? void 0 : submitEvent.target) ?? document.getElementById(FORM_ID);
  ...
  return /* @__PURE__ */ jsx(
    ReusableModal,
    {
      ...
      children: /* @__PURE__ */ jsxs("form", { id: FORM_ID, onSubmit: (e) => {
        e.preventDefault();
        handleConfirm(e);
      }, children: [
