...
function renderCellContent(value, column, rowData = {}) {
  ...
  if (column.key === "phones") {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      (primary == null ? void 0 : primary.is_whatsapp) && /* @__PURE__ */ jsx("i", { className: "lab la-whatsapp ms-2" }),
      moreCount > 0 && /* @__PURE__ */ jsx("span", { className: "badge bg-secondary ms-2", children: moreCount === 1 ? "1 más" : `${moreCount} más` })
    ] });
  }
  if (column.type === "link") {
    if (value) {
